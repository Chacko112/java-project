...
public class HomePanel extends JPanel {
    ...
    public HomePanel(String managerName) {
        ...
        JLabel welcomeLabel = new JLabel("Welcome, " + managerName + "! Here's today's overview.");
        ...
        // --- Right: Enlarged Date & Time Panel ---
        ...
        dateTimePanel.setPreferredSize(new Dimension(260, 200)); // ✅ Larger block
