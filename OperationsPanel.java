...
public class OperationsPanel extends JPanel {
    ...
    public void initDummyData() {
        ...
        rooms.add(new RoomInfo(102, "Double", true));
        rooms.add(new RoomInfo(103, "Suite", true));

        BookingManager.addBooking(bookings, "Alice", 101, today, today.plusDays(2));
        BookingManager.addBooking(bookings, "Bob", 102, today.minusDays(1), today);
        BookingManager.addBooking(bookings, "Charlie", 103, today.plusDays(1), today.plusDays(3));
    }
    ...
    public void showCheckInDialog() {
        ...
        dialog.add(new JLabel("Room No:")); dialog.add(roomField);
